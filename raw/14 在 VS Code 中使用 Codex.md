...
![搜索并安装 Codex 插件](attachments/image-20260511192103991.png)

## 打开插件对话窗口

安装完成后，在 VS Code 中打开任意一个项目文件，右上角会出现 ChatGPT 的图标。点击该图标，右侧边栏就会展开 Codex 的对话窗口。

![文件右上角的插件图标](attachments/image-20260511192430989.png)

![展开后的对话窗口](attachments/image-20260511192548524.png)
...
![使用 @ 指定文件](attachments/image-20260511192700125.png)
