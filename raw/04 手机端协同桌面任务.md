...
![ChatGPT 手机 App 中的 Codex 入口](mobile-codex-ios-app.jpg)


连接桌面 Codex APP：

![手机端连接桌面 Codex App](mobile-codex-connect-desktop.jpg)


在 ChatGPT 里打开 Codex 就能用。

![在 ChatGPT 手机 App 中打开 Codex](mobile-codex-chatgpt-entry.jpg)
