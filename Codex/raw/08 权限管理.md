...
![Codex App 权限选择器示例](./assets/AI本地知识库/codex-app-permissions-selector-menu.png)
...
![Codex App 自动审核拒绝高风险操作示例](./assets/AI本地知识库/codex-app-auto-review-rejection.png)
...
![Codex App config.toml 配置示例](./assets/AI本地知识库/codex-app-config-toml-settings.png)
