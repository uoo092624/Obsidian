...
source: "https://codexguide.ai/guide/09-skills-plugins.html"
author:
  - "[[canghe]]"
...
![codex-skills-plugins-entry-page](https://codexguide.ai/assets/codex-skills-plugins-entry-page-B7BZL04_.png)
...
![codex-skills-list](https://codexguide.ai/assets/codex-skills-list-g6o-xddT.png)
...
![codex-skills-slash-command-list](https://codexguide.ai/assets/codex-skills-slash-command-list-Dgz6ouiw.png)
...
![codex-plugins-at-command-list](https://codexguide.ai/assets/codex-plugins-at-command-list-Rn-W8HKd.png)

安装或导入插件时，Codex 通常会要求你确认来源和能力范围：

![codex-plugin-install-github-prompt](https://codexguide.ai/assets/codex-plugin-install-github-prompt-rqum85w5.png)
