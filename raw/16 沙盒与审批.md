...
![Codex 沙盒、审批策略、审批人与配置项关系图](attachments/codex-safety-layers.svg)
...
![Codex 配置中的沙盒设置选项](attachments/codex-config-sandbox-settings.png)
...
![Codex 配置中的审批策略选项](attachments/codex-config-approval-policy.png)
