...
![Codex App 权限选择器示例](codex-app-permissions-selector-menu.png)
...
![Codex App 自动审核拒绝高风险操作示例](codex-app-auto-review-rejection.png)
...
![Codex App config.toml 配置示例](codex-app-config-toml-settings.png)
