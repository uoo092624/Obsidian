...
![Codex 桌面 App 主界面](./assets/03 了解 Codex 桌面 App/image-20260511150406204.png)
...
![Project 工作区界面](./assets/03 了解 Codex 桌面 App/image-20260511150432591.png)
...
![对话框功能区](./assets/03 了解 Codex 桌面 App/image-20260511174720640.png)
...
![Codex 插件与技能](./assets/03 了解 Codex 桌面 App/codex-plugin-marketplace.png)

Skills 默认包含 Skills Creator、Skills Installer、OpenAI Docs 等技能，用来创建、安装技能，或获取 OpenAI 官方最新文档。在对话框中使用 `$` 即可调用 Skills：

![Codex Skills 调用](./assets/03 了解 Codex 桌面 App/codex-skills-command.png)

插件是 OpenAI 定义的外部工具入口，也可能包含 Skills、MCP、脚本等能力。常见插件包括 Computer Use、Browser Use、PPT、Docs、Excel、Slack、GitHub 等。不同插件可能有额外配置。

![Codex 插件配置](./assets/03 了解 Codex 桌面 App/codex-plugin-config.png)

## 自动化

Codex 支持自动化执行任务，包括使用 MCP 服务器、钩子和插件等。

![Codex 自动化总览](./assets/03 了解 Codex 桌面 App/codex-automation-overview.png)

自动化会执行你指定的命令，你可以指定工作树、项目地址和定时的间隔。在下图中输入你的指令，并且配置即可。

![Codex 创建自动化](./assets/03 了解 Codex 桌面 App/codex-automation-create.png)
...
![设置入口](./assets/03 了解 Codex 桌面 App/image-20260511175034743.png)

![设置面板详情](./assets/03 了解 Codex 桌面 App/image-20260511175220089.png)
